...
static void nativeDelete(JNIEnv* env, jclass clazz, jlong ptr, jobject buffer)
{
    leveldb::WriteBatch* batch = reinterpret_cast<leveldb::WriteBatch*>(ptr);
...
static void nativePut(JNIEnv* env, jclass clazz, jlong ptr, jobject keyObj, jobject valObj)
{
    leveldb::WriteBatch* batch = reinterpret_cast<leveldb::WriteBatch*>(ptr);
