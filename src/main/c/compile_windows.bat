...
REM Compile zlib
msbuild.exe zlib\zlib-1.2.11\contrib\vstudio\vc14\zlibstat.vcxproj /p:Configuration=ReleaseWithoutAsm /p:Platform=x64
mkdir zlib\zlib
...
REM Compile leveldb
msbuild.exe leveldb-mcpe\leveldb.vcxproj /p:Configuration=Release /p:Platform=x64 /p:ZlibLibPath=%dir%zlib\zlib-1.2.11\contrib\vstudio\vc14\x64\ZlibStatReleaseWithoutAsm\zlibstat.lib /p:ZlibIncludePath=%dir%zlib\
