#!/bin/sh
CWD=$(pwd)
CXX="g++ -std=c++11 -s -shared -fPIC -fno-builtin-memcmp -DOS_WINDOWS -DLEVELDB_PLATFORM_POSIX -DLEVELDB_ATOMIC_PRESENT -DNDEBUG -O2 -DDLLX= -pthread -I$JAVA_HOME/include/ -I$JAVA_HOME/include/win32/ -I$CWD/leveldb-mcpe/ -I$CWD/leveldb-mcpe/include/"
