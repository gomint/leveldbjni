...
{
    leveldb::DB* db = reinterpret_cast<leveldb::DB*>(dbPtr);
    readOptions.snapshot = reinterpret_cast<leveldb::Snapshot*>(snapshotPtr);
...
static jbyteArray nativeGetBB(JNIEnv * env, jclass clazz, jlong dbPtr, jlong snapshotPtr, jobject keyObj)
{
    leveldb::DB* db = reinterpret_cast<leveldb::DB*>(dbPtr);
...
static void nativePut(JNIEnv *env, jclass clazz, jlong dbPtr, jbyteArray keyObj, jbyteArray valObj)
{
    leveldb::DB* db = reinterpret_cast<leveldb::DB*>(dbPtr);
    ...
    leveldb::Status status = db->Put(leveldb::WriteOptions(), leveldb::Slice((const char *) keyBuf, keyLen), leveldb::Slice((const char *) valBuf, valLen));
...
static void nativeDelete(JNIEnv *env, jclass clazz, jlong dbPtr, jbyteArray keyObj)
{
    leveldb::DB* db = reinterpret_cast<leveldb::DB*>(dbPtr);
